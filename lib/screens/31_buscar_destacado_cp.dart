...
class Buscar_descp extends StatefulWidget {
  const Buscar_descp({super.key});

  @override
  State<Buscar_descp> createState() => _Buscar_descpState();
}

class _Buscar_descpState extends State<Buscar_descp> {
  int x = 0;
  @override
...
class Negocio1 extends StatelessWidget {
...
class Negocio2 extends StatelessWidget {
  static const TextStyle estilo = TextStyle(
    fontSize: 16,
    color: Color(0xff15294B),
  );
...
class Boton extends Buscar_descp {
  boton() {
    int x = 1;
    print(1);
  }
