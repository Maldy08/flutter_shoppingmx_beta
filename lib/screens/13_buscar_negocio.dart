...
class Buscar_ne extends StatefulWidget {
  const Buscar_ne({super.key});

  @override
  State<Buscar_ne> createState() => _Buscar_neState();
}

class _Buscar_neState extends State<Buscar_ne> {
  int x = 0;
  @override
