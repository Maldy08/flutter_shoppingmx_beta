...
class Buscar_prom extends StatefulWidget {
  const Buscar_prom({super.key});

  @override
  State<Buscar_prom> createState() => _Buscar_promState();
}

class _Buscar_promState extends State<Buscar_prom> {
  int x = 0;
  @override
...
class Boton extends Buscar_prom {
  boton() {
    int x = 1;
    print(1);
  }
