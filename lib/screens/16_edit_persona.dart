...
class Edit_per extends StatefulWidget {
  const Edit_per({super.key});

  @override
  State<Edit_per> createState() => _Edit_perState();
}

class _Edit_perState extends State<Edit_per> {
  int x = 0;
  @override
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      initialValue: Sexo, //cambiar a seleccion
                      readOnly: edit3,
                      decoration: InputDecoration(
                        border: InputBorder.none,
                      ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      initialValue: Codigop, //cambiar a seleccion
                      readOnly: edit6,
                      keyboardType: TextInputType.number,
                      decoration: InputDecoration(
                        border: InputBorder.none,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      initialValue: Interes, //cambiar a seleccion
                      readOnly: edit7,
                      decoration: InputDecoration(
                        border: InputBorder.none,
                      ),
