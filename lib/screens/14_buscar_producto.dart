...
class Buscar_po extends StatefulWidget {
  const Buscar_po({super.key});

  @override
  State<Buscar_po> createState() => _Buscar_poState();
}

class _Buscar_poState extends State<Buscar_po> {
  int x = 0;
  @override
