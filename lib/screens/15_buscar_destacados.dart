...
class Buscar_des extends StatefulWidget {
  const Buscar_des({super.key});

  @override
  State<Buscar_des> createState() => _Buscar_desState();
}

class _Buscar_desState extends State<Buscar_des> {
  int x = 0;
  @override
...
class Boton extends Buscar_des {
  boton() {
    int x = 1;
    print(1);
  }
